import{u,k as l,E as p,o as c,B as e,h as d,q as r,_hW as h}from"./q-Cn9eRv09.js";import{_ as s}from"./q-XYi0b4s7.js";const x=()=>{const[o,t]=u();let n=0;const a=setInterval(()=>{n<=61?(o.value="Full-Stack Developer | Problem Solver | Innovation Enthusiast".slice(0,n),n++):clearInterval(a)},50),i=setInterval(()=>{t.value=!t.value},500);return()=>{clearInterval(a),clearInterval(i)}},m=Object.freeze(Object.defineProperty({__proto__:null,_hW:h,s_qJmIgBWFER0:x},Symbol.toStringTag,{value:"Module"})),b=`
    .hero-section {
      min-height: 100vh;
      display: flex;
      align-items: center;
