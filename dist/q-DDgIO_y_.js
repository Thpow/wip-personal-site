...
}`;function $t(t={}){return t.debug?Ct:Et}function M(){if(typeof performance>"u")return()=>0;const t=performance.now();return()=>(performance.now()-t)/1e6}function Pt(t){let e=t.base;return typeof t.base=="function"&&(e=t.base(t)),typeof e=="string"?(e.endsWith("/")||(e+="/"),e):"/build/"}var It="<!DOCTYPE html>";async function jt(t,e){var ie,le,ce;let n=e.stream,r=0,a=0,o=0,i=0,s="",l;const d=((ie=e.streaming)==null?void 0:ie.inOrder)??{strategy:"auto",maximunInitialChunk:5e4,maximunChunk:3e4},c=e.containerTagName??"html",u=e.containerAttributes??{},m=n,y=M(),f=Pt(e),p=De(e.manifest);function j(){s&&(m.write(s),s="",r=0,o++,o===1&&(i=y()))}function k(v){const x=v.length;r+=x,a+=x,s+=v}switch(d.strategy){case"disabled":n={write:k};break;case"direct":n=m;break;case"auto":let v=0,x=!1;const ue=d.maximunChunk??0,V=d.maximunInitialChunk??0;n={write(A){A==="<!--qkssr-f-->"?x||(x=!0):A==="<!--qkssr-pu-->"?v++:A==="<!--qkssr-po-->"?v--:k(A),v===0&&(x||r>=(o===0?V:ue))&&(x=!1,j())}};break}c==="html"?n.write(It):n.write("<!--cq-->"),p||console.warn("Missing client manifest, loading symbols in the client might 404. Please ensure the client build has run and generated the manifest for the server build."),await nt(e,p);const D=p==null?void 0:p.manifest.injections,h=D?D.map(v=>b(v.tag,v.attributes??{})):[],L=((le=e.qwikLoader)==null?void 0:le.include)??"auto",E=p==null?void 0:p.manifest.qwikLoader;let J=!1;L!=="never"&&E&&(h.unshift(b("link",{rel:"modulepreload",href:`${f}${E}`}),b("script",{type:"module",async:!0,src:`${f}${E}`})),J=!0),wt(f,p,e.preloader,h,(ce=e.serverData)==null?void 0:ce.nonce);const K=M(),W=[];let z=0,C=0;await Te(t,{stream:n,containerTagName:c,containerAttributes:u,serverData:e.serverData,base:f,beforeContent:h,beforeClose:async(v,x,ue,V)=>{var pe,me,fe,he;z=K();const A=M();l=await Ue(v,x,void 0,V);const P=[];_t(f,l,e,p,P);const ze=JSON.stringify(l.state,void 0,void 0);if(P.push(b("script",{type:"qwik/json",dangerouslySetInnerHTML:Lt(ze),nonce:(pe=e.serverData)==null?void 0:pe.nonce})),l.funcs.length>0){const I=u[rt];P.push(b("script",{"q:func":"qwik/json",dangerouslySetInnerHTML:Nt(I,l.funcs),nonce:(me=e.serverData)==null?void 0:me.nonce}))}const Be=!l||l.mode!=="static";if(!J&&(L==="always"||L==="auto"&&Be)){const I=$t({debug:e.debug});P.push(b("script",{id:"qwikloader",async:!0,type:"module",dangerouslySetInnerHTML:I,nonce:(fe=e.serverData)==null?void 0:fe.nonce}))}const de=Array.from(x.$events$,I=>JSON.stringify(I));if(de.length>0){const I=`(window.qwikevents||(window.qwikevents=[])).push(${de.join(",")})`;P.push(b("script",{dangerouslySetInnerHTML:I,nonce:(he=e.serverData)==null?void 0:he.nonce}))}return At(W,v),C=A(),b(H,{children:P})},manifestHash:(p==null?void 0:p.manifest.manifestHash)||"dev"+Dt()}),c!=="html"&&n.write("<!--/cq-->"),j();const Z=l.resources.some(v=>v._cache!==1/0);return{prefetchResources:void 0,snapshotResult:l,flushes:o,manifest:p==null?void 0:p.manifest,size:a,isStatic:!Z,timing:{render:z,snapshot:C,firstFlush:i}}}function Dt(){return Math.random().toString(36).slice(2)}function De(t){const e=t?{...ve,...t}:ve;if(!e||"mapper"in e)return e;if(e.mapping){const n={};return Object.entries(e.mapping).forEach(([r,a])=>{n[O(r)]=[r,a]}),{mapper:n,manifest:e,injections:e.injections||[]}}}var Lt=t=>t.replace(/<(\/?script)/gi,"\\x3C$1");function At(t,e){var n;for(const r of e){const a=(n=r.$componentQrl$)==null?void 0:n.getSymbol();a&&!t.includes(a)&&t.push(a)}}var Rt='document["qFuncs_HASH"]=';function Nt(t,e){return Rt.replace("HASH",t)+`[${e.join(`,
`)}]`}async function gn(t){const e=Ee({},De(t));_e(e)}const zt=S("qc-s"),Bt=S("qc-c"),Le=S("qc-ic"),Ae=S("qc-h"),Re=S("qc-l"),Tt=S("qc-n"),Ut=S("qc-a"),Ft=S("qc-ir"),Ot=S("qc-p"),Qt=Ye(Ze("s_9KRx0IOCHt8")),Yt=()=>{if(!se("containerAttributes"))throw new Error("PrefetchServiceWorker component must be rendered on the server.");Oe();const e=oe(Le);if(e.value&&e.value.length>0){const n=e.value.length;let r=null;for(let a=n-1;a>=0;a--)e.value[a].default&&(r=q(e.value[a].default,{children:r},1,"ni_0"));return q(H,{children:[r,g("script",{"document:onQCInit$":Qt,"document:onQInit$":Qe(()=>{((a,o)=>{var i;if(!a._qcs&&o.scrollRestoration==="manual"){a._qcs=!0;const s=(i=o.state)==null?void 0:i._qCityScroll;s&&a.scrollTo(s.x,s.y),document.dispatchEvent(new Event("qcinit"))}})(window,history)},'()=>{((w,h)=>{if(!w._qcs&&h.scrollRestoration==="manual"){w._qcs=true;const s=h.state?._qCityScroll;if(s){w.scrollTo(s.x,s.y);}document.dispatchEvent(new Event("qcinit"));}})(window,history);}')},null,null,2,"ni_1")]},1,"ni_2")}return Ge},Gt=R(w(Yt,"s_ScE8eseirUA")),Ht=(t,e)=>new URL(t,e.href),ye=(t,e)=>t.origin===e.origin,xe=t=>t.endsWith("/")?t:t+"/",Jt=({pathname:t},{pathname:e})=>{const n=Math.abs(t.length-e.length);return n===0?t===e:n===1&&xe(t)===xe(e)},Kt=(t,e)=>t.search===e.search,G=(t,e)=>Kt(t,e)&&Jt(t,e),Wt=t=>t&&typeof t.then=="function",Zt=(t,e,n,r)=>{const a=Ne(),i={head:a,withLocale:s=>ge(r,s),resolveValue:s=>{const l=s.__id;if(s.__brand==="server_loader"&&!(l in t.loaders))throw new Error("You can not get the returned data of a loader that has not been executed for this request.");const d=t.loaders[l];if(Wt(d))throw new Error("Loaders returning a promise can not be resolved for the head function.");return d},...e};for(let s=n.length-1;s>=0;s--){const l=n[s]&&n[s].head;l&&(typeof l=="function"?we(a,ge(r,()=>l(i))):typeof l=="object"&&we(a,l))}return i.head},we=(t,e)=>{typeof e.title=="string"&&(t.title=e.title),U(t.meta,e.meta),U(t.links,e.links),U(t.styles,e.styles),U(t.scripts,e.scripts),Object.assign(t.frontmatter,e.frontmatter)},U=(t,e)=>{if(Array.isArray(e))for(const n of e){if(typeof n.key=="string"){const r=t.findIndex(a=>a.key===n.key);if(r>-1){t[r]=n;continue}}t.push(n)}},Ne=()=>({title:"",meta:[],links:[],styles:[],scripts:[],frontmatter:{}}),Vt=()=>oe(Ae),Xt=()=>oe(Re),Mt=()=>qe(se("qwikcity")),ke={},F={navCount:0},en=":root{view-transition-name:none}",tn=t=>{},nn=async(t,e)=>{const[n,r,a,o]=Se(),{type:i="link",forceReload:s=t===void 0,replaceState:l=!1,scroll:d=!0}=typeof e=="object"?e:{forceReload:e};F.navCount++;const c=a.value.dest,u=t===void 0?c:typeof t=="number"?t:Ht(t,o.url);if(ke.$cbs$&&(s||typeof u=="number"||!G(u,c)||!ye(u,c))){const m=F.navCount,y=await Promise.all([...ke.$cbs$.values()].map(f=>f(u)));if(m!==F.navCount||y.some(Boolean)){m===F.navCount&&i==="popstate"&&history.pushState(null,"",c);return}}if(typeof u!="number"&&ye(u,c)&&!(!s&&G(u,c)))return a.value={type:i,dest:u,forceReload:s,replaceState:l,scroll:d},n.value=void 0,o.isNavigating=!0,new Promise(m=>{r.r=m})},rn=({track:t})=>{const[e,n,r,a,o,i,s,l,d,c,u]=Se();async function m(){const[f,p]=t(()=>[c.value,e.value]),j=Ve(""),k=u.url,D=p?"form":f.type;f.replaceState;let h,L,E=null;if(h=new URL(f.dest,u.url),E=o.loadedRoute,L=o.response,E){const[J,K,W,z]=E,C=W,Z=C[C.length-1];f.dest.search&&G(h,k)&&(h.search=f.dest.search),G(h,k)||(u.prevUrl=k),u.url=h,u.params={...K},c.untrackedValue={type:D,dest:h};const $=Zt(L,u,C,j);n.headings=Z.headings,n.menu=z,r.value=qe(C),a.links=$.links,a.meta=$.meta,a.styles=$.styles,a.scripts=$.scripts,a.title=$.title,a.frontmatter=$.frontmatter}}return m()},an=t=>{He(w(en,"s_K4gvalEGCME"));const e=Mt();if(!(e!=null&&e.params))throw new Error("Missing Qwik City Env Data for help visit https://github.com/QwikDev/qwik/issues/6237");const n=se("url");if(!n)throw new Error("Missing Qwik URL Env Data");if(e.ev.originalUrl.pathname!==e.ev.url.pathname)throw new Error('enableRequestRewrite is an experimental feature and is not enabled. Please enable the feature flag by adding `experimental: ["enableRequestRewrite"]` to your qwikVite plugin options.');const r=new URL(n),a=B({url:r,params:e.params,isNavigating:!1,prevUrl:void 0},{deep:!1}),o={},i=Je(B(e.response.loaders,{deep:!1})),s=X({type:"initial",dest:r,forceReload:!1,replaceState:!1,scroll:!0}),l=B(Ne),d=B({headings:void 0,menu:void 0}),c=X(),u=e.response.action,m=u?e.response.loaders[u]:void 0,y=X(m?{id:u,data:e.response.formData,output:{result:m,status:e.response.status}}:void 0),f=w(tn,"s_qGVD1Sz413o"),p=w(nn,"s_aww2BzpANGM",[y,o,s,a]);return _(Bt,d),_(Le,c),_(Ae,l),_(Re,a),_(Tt,p),_(zt,i),_(Ut,y),_(Ft,s),_(Ot,f),Ke(w(rn,"s_Ysfvd0zsHZc",[y,d,c,l,e,p,i,o,t,s,a])),q(We,null,3,"ni_3")},on=R(w(an,"s_p1yCGpFL1xE")),sn=()=>{const t=Vt(),e=Xt();return q(H,{children:[g("title",null,null,t.title,1,null),g("link",null,{rel:"canonical",href:Xe(n=>n.url.href,[e],"p0.url.href")},null,3,null),g("meta",null,{name:"viewport",content:"width=device-width, initial-scale=1.0"},null,3,null),g("link",null,{rel:"icon",type:"image/png",href:"/ico.png"},null,3,null),t.meta.map(n=>T("meta",{...n},null,0,n.key)),t.links.map(n=>T("link",{...n},null,0,n.key)),t.styles.map(n=>{var r;return T("style",{...n.props,...(r=n.props)!=null&&r.dangerouslySetInnerHTML?{}:{dangerouslySetInnerHTML:n.style}},null,0,n.key)}),t.scripts.map(n=>{var r;return T("script",{...n.props,...(r=n.props)!=null&&r.dangerouslySetInnerHTML?{}:{dangerouslySetInnerHTML:n.script}},null,0,n.key)})]},1,"0D_0")},ln=R(w(sn,"s_0vphQYqOdZI")),cn=`
    .background-shapes {
      position: fixed;
      top: 0;
      left: 0;
