 ...
 */var et=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')}),tt="<sync>";function Ce(t,e){const n=e==null?void 0:e.mapper,r=t.symbolMapper?t.symbolMapper:(s,i,o)=>{var l;if(n){const d=U(s),c=n[d];if(!c){if(d===tt)return[d,""];if((l=globalThis.__qwik_reg_symbols)==null?void 0:l.has(d))return[s,"_"];if(o)return[s,`${o}?qrl=${s}`];console.error("Cannot resolve symbol",s,"in",n,o)}return c}};return{isServer:!0,async importSymbol(s,i,o){var m;const l=U(o),d=(m=globalThis.__qwik_reg_symbols)==null?void 0:m.get(l);if(d)return d;let c=String(i);c.endsWith(".js")||(c+=".js");const u=et(c);if(!(o in u))throw new Error(`Q-ERROR: missing symbol '${o}' in module '${c}'.`);return u[o]},raf:()=>(console.error("server can not rerender"),Promise.resolve()),nextTick:s=>new Promise(i=>{setTimeout(()=>{i(s())})}),chunkForSymbol(s,i,o){return r(s,n,o)}}}async function nt(t,e){const n=Ce(t,e);_e(n)}var U=t=>{const e=t.lastIndexOf("_");return e>-1?t.slice(e+1):t},rt="q:instance",Y={$DEBUG$:!1,$invPreloadProbability$:.65},at=Date.now(),st=/\.[mc]?js$/,$e=0,ot=1,it=2,lt=3,ee,te,ct=(t,e)=>({$name$:t,$state$:st.test(t)?$e:lt,$deps$:Pe?e==null?void 0:e.map(n=>({...n,$factor$:1})):e,$inverseProbability$:1,$createdTs$:Date.now(),$waitedMs$:0,$loadedMs$:0}),ut=t=>{const e=new Map;let n=0;for(;n<t.length;){const r=t[n++],a=[];let s,i=1;for(;s=t[n],typeof s=="number";)s<0?i=-s/10:a.push({$name$:t[s],$importProbability$:i,$factor$:1}),n++;e.set(r,a)}return e},Ee=t=>{let e=ne.get(t);if(!e){let n;if(te){if(n=te.get(t),!n)return;n.length||(n=void 0)}e=ct(t,n),ne.set(t,e)}return e},dt=(t,e)=>{e&&("debug"in e&&(Y.$DEBUG$=!!e.debug),typeof e.preloadProbability=="number"&&(Y.$invPreloadProbability$=1-e.preloadProbability)),!(ee!=null||!t)&&(ee="",te=ut(t))},ne=new Map,Pe,F,je=0,z=[],pt=(...t)=>{console.log(`Preloader ${Date.now()-at}ms ${je}/${z.length} queued>`,...t)},mt=()=>{ne.clear(),F=!1,Pe=!0,je=0,z.length=0},ft=()=>{F&&(z.sort((t,e)=>t.$inverseProbability$-e.$inverseProbability$),F=!1)},ht=()=>{ft();let t=.4;const e=[];for(const n of z){const r=Math.round((1-n.$inverseProbability$)*10);r!==t&&(t=r,e.push(t)),e.push(n.$name$)}return e},Ie=(t,e,n)=>{if(n!=null&&n.has(t))return;const r=t.$inverseProbability$;if(t.$inverseProbability$=e,!(r-t.$inverseProbability$<.01)&&(ee!=null&&t.$state$<it&&t.$inverseProbability$<Y.$invPreloadProbability$&&(t.$state$===$e&&(t.$state$=ot,z.push(t),Y.$DEBUG$&&pt(`queued ${Math.round((1-t.$inverseProbability$)*100)}%`,t.$name$)),F=!0),t.$deps$)){n||(n=new Set),n.add(t);const a=1-t.$inverseProbability$;for(const s of t.$deps$){const i=Ee(s.$name$);if(i.$inverseProbability$===0)continue;let o;if(s.$importProbability$>.5&&(a===1||a>=.99&&re<100))re++,o=Math.min(.01,1-s.$importProbability$);else{const l=1-s.$importProbability$*a,d=s.$factor$,c=l/d;o=Math.max(.02,i.$inverseProbability$*c),s.$factor$=c}Ie(i,o,n)}}},be=(t,e)=>{const n=Ee(t);n&&n.$inverseProbability$>e&&Ie(n,e)},re,gt=(t,e)=>{if(!(t!=null&&t.length))return;re=0;let n=e?1-e:.4;if(Array.isArray(t))for(let r=t.length-1;r>=0;r--){const a=t[r];typeof a=="number"?n=1-a/10:be(a,n)}else be(t,n)};function vt(t){const e=[],n=r=>{if(r)for(const a of r)e.includes(a.url)||(e.push(a.url),a.imports&&n(a.imports))};return n(t),e}var bt=t=>{var n;const e=Qe();return(n=t==null?void 0:t.qrls)==null?void 0:n.map(r=>{var o;const a=r.$refSymbol$||r.$symbol$,s=r.$chunk$,i=e.chunkForSymbol(a,s,(o=r.dev)==null?void 0:o.file);return i?i[1]:s}).filter(Boolean)};function xt(t,e,n){const r=e.prefetchStrategy;if(r===null)return[];if(!(n!=null&&n.manifest.bundleGraph))return bt(t);if(typeof(r==null?void 0:r.symbolsToPrefetch)=="function")try{const s=r.symbolsToPrefetch({manifest:n.manifest});return vt(s)}catch(s){console.error("getPrefetchUrls, symbolsToPrefetch()",s)}const a=new Set;for(const s of(t==null?void 0:t.qrls)||[]){const i=U(s.$refSymbol$||s.$symbol$);i&&i.length>=10&&a.add(i)}return[...a]}var yt=(t,e)=>{if(!(e!=null&&e.manifest.bundleGraph))return[...new Set(t)];mt();let n=.99;for(const r of t.slice(0,15))gt(r,n),n*=.85;return ht()},ae=(t,e)=>{if(e==null)return null;const n=`${t}${e}`.split("/"),r=[];for(const a of n)a===".."&&r.length>0?r.pop():r.push(a);return r.join("/")},wt=(t,e,n,r,a)=>{var l;const s=ae(t,(l=e==null?void 0:e.manifest)==null?void 0:l.preloader),i="/"+(e==null?void 0:e.manifest.bundleGraphAsset);if(s&&i&&n!==!1){const d=typeof n=="object"?{debug:n.debug,preloadProbability:n.ssrPreloadProbability}:void 0;dt(e==null?void 0:e.manifest.bundleGraph,d);const c=[];n!=null&&n.debug&&c.push("d:1"),n!=null&&n.maxIdlePreloads&&c.push(`P:${n.maxIdlePreloads}`),n!=null&&n.preloadProbability&&c.push(`Q:${n.preloadProbability}`);const u=c.length?`,{${c.join(",")}}`:"",m=`let b=fetch("${i}");import("${s}").then(({l})=>l(${JSON.stringify(t)},b${u}));`;r.push(b("link",{rel:"modulepreload",href:s}),b("link",{rel:"preload",href:i,as:"fetch",crossorigin:"anonymous"}),b("script",{type:"module",async:!0,dangerouslySetInnerHTML:m,nonce:a}))}const o=ae(t,e==null?void 0:e.manifest.core);o&&r.push(b("link",{rel:"modulepreload",href:o}))},kt=(t,e,n,r,a)=>{if(r.length===0||n===!1)return null;const{ssrPreloads:s,ssrPreloadProbability:i}=qt(typeof n=="boolean"?void 0:n);let o=s;const l=[],d=[],c=e==null?void 0:e.manifest.manifestHash;if(o){const f=e==null?void 0:e.manifest.preloader,p=e==null?void 0:e.manifest.core,I=yt(r,e);let k=4;const L=i*10;for(const h of I)if(typeof h=="string"){if(k<L)break;if(h===f||h===p)continue;if(d.push(h),--o===0)break}else k=h}const u=ae(t,c&&(e==null?void 0:e.manifest.preloader));let x=d.length?`${JSON.stringify(d)}.map((l,e)=>{e=document.createElement('link');e.rel='modulepreload';e.href=${JSON.stringify(t)}+l;document.head.appendChild(e)});`:"";return u&&(x+=`window.addEventListener('load',f=>{f=_=>import("${u}").then(({p})=>p(${JSON.stringify(r)}));try{requestIdleCallback(f,{timeout:2000})}catch(e){setTimeout(f,200)}})`),x&&l.push(b("script",{type:"module","q:type":"preload",async:!0,dangerouslySetInnerHTML:x,nonce:a})),l.length>0?b(V,{children:l}):null},_t=(t,e,n,r,a)=>{var s;if(n.preloader!==!1){const i=xt(e,n,r);if(i.length>0){const o=kt(t,r,n.preloader,i,(s=n.serverData)==null?void 0:s.nonce);o&&a.push(o)}}};function qt(t){return{...St,...t}}var St={ssrPreloads:7,ssrPreloadProbability:.5,debug:!1,maxIdlePreloads:25,preloadProbability:.35},Ct='const t=document,e=window,n=new Set,o=new Set([t]);let r;const s=(t,e)=>Array.from(t.querySelectorAll(e)),i=t=>{const e=[];return o.forEach((n=>e.push(...s(n,t)))),e},a=t=>{g(t),s(t,"[q\\\\:shadowroot]").forEach((t=>{const e=t.shadowRoot;e&&a(e)}))},c=t=>t&&"function"==typeof t.then;let l=!0;const f=(t,e,n=e.type)=>{let o=l;i("[on"+t+"\\\\:"+n+"]").forEach((r=>{o=!0,b(r,t,e,n)})),o||window[t.slice(1)].removeEventListener(n,"-window"===t?d:_)},p=e=>{if(void 0===e._qwikjson_){let n=(e===t.documentElement?t.body:e).lastElementChild;for(;n;){if("SCRIPT"===n.tagName&&"qwik/json"===n.getAttribute("type")){e._qwikjson_=JSON.parse(n.textContent.replace(/\\\\x3C(\\/?script)/gi,"<$1"));break}n=n.previousElementSibling}}},u=(t,e)=>new CustomEvent(t,{detail:e}),b=async(e,n,o,r=o.type)=>{const s="on"+n+":"+r;e.hasAttribute("preventdefault:"+r)&&o.preventDefault(),e.hasAttribute("stoppropagation:"+r)&&o.stopPropagation();const i=e._qc_,a=i&&i.li.filter((t=>t[0]===s));if(a&&a.length>0){for(const t of a){const n=t[1].getFn([e,o],(()=>e.isConnected))(o,e),r=o.cancelBubble;c(n)&&await n,r&&o.stopPropagation()}return}const l=e.getAttribute(s);if(l){const n=e.closest("[q\\\\:container]"),r=n.getAttribute("q:base"),s=n.getAttribute("q:version")||"unknown",i=n.getAttribute("q:manifest-hash")||"dev",a=new URL(r,t.baseURI);for(const f of l.split("\\n")){const l=new URL(f,a),u=l.href,b=l.hash.replace(/^#?([^?[|]*).*$/,"$1")||"default",q=performance.now();let _,d,w;const m=f.startsWith("#"),y={qBase:r,qManifest:i,qVersion:s,href:u,symbol:b,element:e,reqTime:q};if(m){const e=n.getAttribute("q:instance");_=(t["qFuncs_"+e]||[])[Number.parseInt(b)],_||(d="sync",w=Error("sym:"+b))}else{h("qsymbol",y);const t=l.href.split("#")[0];try{const e=import(t);p(n),_=(await e)[b],_||(d="no-symbol",w=Error(`${b} not in ${t}`))}catch(t){d||(d="async"),w=t}}if(!_){h("qerror",{importError:d,error:w,...y}),console.error(w);break}const g=t.__q_context__;if(e.isConnected)try{t.__q_context__=[e,o,l];const n=_(o,e);c(n)&&await n}catch(t){h("qerror",{error:t,...y})}finally{t.__q_context__=g}}}},h=(e,n)=>{t.dispatchEvent(u(e,n))},q=t=>t.replace(/([A-Z])/g,(t=>"-"+t.toLowerCase())),_=async t=>{let e=q(t.type),n=t.target;for(f("-document",t,e);n&&n.getAttribute;){const o=b(n,"",t,e);let r=t.cancelBubble;c(o)&&await o,r||(r=r||t.cancelBubble||n.hasAttribute("stoppropagation:"+t.type)),n=t.bubbles&&!0!==r?n.parentElement:null}},d=t=>{f("-window",t,q(t.type))},w=()=>{var s;const c=t.readyState;if(!r&&("interactive"==c||"complete"==c)&&(o.forEach(a),r=1,h("qinit"),(null!=(s=e.requestIdleCallback)?s:e.setTimeout).bind(e)((()=>h("qidle"))),n.has("qvisible"))){const t=i("[on\\\\:qvisible]"),e=new IntersectionObserver((t=>{for(const n of t)n.isIntersecting&&(e.unobserve(n.target),b(n.target,"",u("qvisible",n)))}));t.forEach((t=>e.observe(t)))}},m=(t,e,n,o=!1)=>{t.addEventListener(e,n,{capture:o,passive:!1})};let y;const g=(...t)=>{l=!0,clearTimeout(y),y=setTimeout((()=>l=!1),2e4);for(const r of t)"string"==typeof r?n.has(r)||(o.forEach((t=>m(t,r,_,!0))),m(e,r,d,!0),n.add(r)):o.has(r)||(n.forEach((t=>m(r,t,_,!0))),o.add(r))};if(!("__q_context__"in t)){t.__q_context__=0;const r=e.qwikevents;r&&(Array.isArray(r)?g(...r):g("click","input")),e.qwikevents={events:n,roots:o,push:g},m(t,"readystatechange",w),w()}',$t=`const doc = document;
const win = window;
...
}`;function Et(t={}){return t.debug?$t:Ct}function M(){if(typeof performance>"u")return()=>0;const t=performance.now();return()=>(performance.now()-t)/1e6}function Pt(t){let e=t.base;return typeof t.base=="function"&&(e=t.base(t)),typeof e=="string"?(e.endsWith("/")||(e+="/"),e):"/build/"}var jt="<!DOCTYPE html>";async function It(t,e){var ie,le,ce;let n=e.stream,r=0,a=0,s=0,i=0,o="",l;const d=((ie=e.streaming)==null?void 0:ie.inOrder)??{strategy:"auto",maximunInitialChunk:5e4,maximunChunk:3e4},c=e.containerTagName??"html",u=e.containerAttributes??{},m=n,x=M(),f=Pt(e),p=Le(e.manifest);function I(){o&&(m.write(o),o="",r=0,s++,s===1&&(i=x()))}function k(v){const y=v.length;r+=y,a+=y,o+=v}switch(d.strategy){case"disabled":n={write:k};break;case"direct":n=m;break;case"auto":let v=0,y=!1;const ue=d.maximunChunk??0,X=d.maximunInitialChunk??0;n={write(A){A==="<!--qkssr-f-->"?y||(y=!0):A==="<!--qkssr-pu-->"?v++:A==="<!--qkssr-po-->"?v--:k(A),v===0&&(y||r>=(s===0?X:ue))&&(y=!1,I())}};break}c==="html"?n.write(jt):n.write("<!--cq-->"),p||console.warn("Missing client manifest, loading symbols in the client might 404. Please ensure the client build has run and generated the manifest for the server build."),await nt(e,p);const L=p==null?void 0:p.manifest.injections,h=L?L.map(v=>b(v.tag,v.attributes??{})):[],D=((le=e.qwikLoader)==null?void 0:le.include)??"auto",C=p==null?void 0:p.manifest.qwikLoader;let H=!1;D!=="never"&&C&&(h.unshift(b("link",{rel:"modulepreload",href:`${f}${C}`}),b("script",{type:"module",async:!0,src:`${f}${C}`})),H=!0),wt(f,p,e.preloader,h,(ce=e.serverData)==null?void 0:ce.nonce);const J=M(),G=[];let N=0,$=0;await Be(t,{stream:n,containerTagName:c,containerAttributes:u,serverData:e.serverData,base:f,beforeContent:h,beforeClose:async(v,y,ue,X)=>{var pe,me,fe,he;N=J();const A=M();l=await Oe(v,y,void 0,X);const P=[];_t(f,l,e,p,P);const Ne=JSON.stringify(l.state,void 0,void 0);if(P.push(b("script",{type:"qwik/json",dangerouslySetInnerHTML:Dt(Ne),nonce:(pe=e.serverData)==null?void 0:pe.nonce})),l.funcs.length>0){const j=u[rt];P.push(b("script",{"q:func":"qwik/json",dangerouslySetInnerHTML:zt(j,l.funcs),nonce:(me=e.serverData)==null?void 0:me.nonce}))}const Te=!l||l.mode!=="static";if(!H&&(D==="always"||D==="auto"&&Te)){const j=Et({debug:e.debug});P.push(b("script",{id:"qwikloader",async:!0,type:"module",dangerouslySetInnerHTML:j,nonce:(fe=e.serverData)==null?void 0:fe.nonce}))}const de=Array.from(y.$events$,j=>JSON.stringify(j));if(de.length>0){const j=`(window.qwikevents||(window.qwikevents=[])).push(${de.join(",")})`;P.push(b("script",{dangerouslySetInnerHTML:j,nonce:(he=e.serverData)==null?void 0:he.nonce}))}return At(G,v),$=A(),b(V,{children:P})},manifestHash:(p==null?void 0:p.manifest.manifestHash)||"dev"+Lt()}),c!=="html"&&n.write("<!--/cq-->"),I();const Z=l.resources.some(v=>v._cache!==1/0);return{prefetchResources:void 0,snapshotResult:l,flushes:s,manifest:p==null?void 0:p.manifest,size:a,isStatic:!Z,timing:{render:N,snapshot:$,firstFlush:i}}}function Lt(){return Math.random().toString(36).slice(2)}function Le(t){const e=t?{...ve,...t}:ve;if(!e||"mapper"in e)return e;if(e.mapping){const n={};return Object.entries(e.mapping).forEach(([r,a])=>{n[U(r)]=[r,a]}),{mapper:n,manifest:e,injections:e.injections||[]}}}var Dt=t=>t.replace(/<(\/?script)/gi,"\\x3C$1");function At(t,e){var n;for(const r of e){const a=(n=r.$componentQrl$)==null?void 0:n.getSymbol();a&&!t.includes(a)&&t.push(a)}}var Rt='document["qFuncs_HASH"]=';function zt(t,e){return Rt.replace("HASH",t)+`[${e.join(`,
`)}]`}async function gn(t){const e=Ce({},Le(t));_e(e)}const Nt=S("qc-s"),Tt=S("qc-c"),De=S("qc-ic"),Ae=S("qc-h"),Re=S("qc-l"),Bt=S("qc-n"),Ot=S("qc-a"),Qt=S("qc-ir"),Ut=S("qc-p"),Yt=Fe(Ze("s_9KRx0IOCHt8")),Ft=()=>{if(!oe("containerAttributes"))throw new Error("PrefetchServiceWorker component must be rendered on the server.");Ue();const e=se(De);if(e.value&&e.value.length>0){const n=e.value.length;let r=null;for(let a=n-1;a>=0;a--)e.value[a].default&&(r=q(e.value[a].default,{children:r},1,"ni_0"));return q(V,{children:[r,g("script",{"document:onQCInit$":Yt,"document:onQInit$":Ye(()=>{((a,s)=>{var i;if(!a._qcs&&s.scrollRestoration==="manual"){a._qcs=!0;const o=(i=s.state)==null?void 0:i._qCityScroll;o&&a.scrollTo(o.x,o.y),document.dispatchEvent(new Event("qcinit"))}})(window,history)},'()=>{((w,h)=>{if(!w._qcs&&h.scrollRestoration==="manual"){w._qcs=true;const s=h.state?._qCityScroll;if(s){w.scrollTo(s.x,s.y);}document.dispatchEvent(new Event("qcinit"));}})(window,history);}')},null,null,2,"ni_1")]},1,"ni_2")}return We},Wt=R(w(Ft,"s_ScE8eseirUA")),Vt=(t,e)=>new URL(t,e.href),xe=(t,e)=>t.origin===e.origin,ye=t=>t.endsWith("/")?t:t+"/",Ht=({pathname:t},{pathname:e})=>{const n=Math.abs(t.length-e.length);return n===0?t===e:n===1&&ye(t)===ye(e)},Jt=(t,e)=>t.search===e.search,W=(t,e)=>Jt(t,e)&&Ht(t,e),Gt=t=>t&&typeof t.then=="function",Zt=(t,e,n,r)=>{const a=ze(),i={head:a,withLocale:o=>ge(r,o),resolveValue:o=>{const l=o.__id;if(o.__brand==="server_loader"&&!(l in t.loaders))throw new Error("You can not get the returned data of a loader that has not been executed for this request.");const d=t.loaders[l];if(Gt(d))throw new Error("Loaders returning a promise can not be resolved for the head function.");return d},...e};for(let o=n.length-1;o>=0;o--){const l=n[o]&&n[o].head;l&&(typeof l=="function"?we(a,ge(r,()=>l(i))):typeof l=="object"&&we(a,l))}return i.head},we=(t,e)=>{typeof e.title=="string"&&(t.title=e.title),O(t.meta,e.meta),O(t.links,e.links),O(t.styles,e.styles),O(t.scripts,e.scripts),Object.assign(t.frontmatter,e.frontmatter)},O=(t,e)=>{if(Array.isArray(e))for(const n of e){if(typeof n.key=="string"){const r=t.findIndex(a=>a.key===n.key);if(r>-1){t[r]=n;continue}}t.push(n)}},ze=()=>({title:"",meta:[],links:[],styles:[],scripts:[],frontmatter:{}}),Xt=()=>se(Ae),Kt=()=>se(Re),Mt=()=>qe(oe("qwikcity")),ke={},Q={navCount:0},en=":root{view-transition-name:none}",tn=t=>{},nn=async(t,e)=>{const[n,r,a,s]=Se(),{type:i="link",forceReload:o=t===void 0,replaceState:l=!1,scroll:d=!0}=typeof e=="object"?e:{forceReload:e};Q.navCount++;const c=a.value.dest,u=t===void 0?c:typeof t=="number"?t:Vt(t,s.url);if(ke.$cbs$&&(o||typeof u=="number"||!W(u,c)||!xe(u,c))){const m=Q.navCount,x=await Promise.all([...ke.$cbs$.values()].map(f=>f(u)));if(m!==Q.navCount||x.some(Boolean)){m===Q.navCount&&i==="popstate"&&history.pushState(null,"",c);return}}if(typeof u!="number"&&xe(u,c)&&!(!o&&W(u,c)))return a.value={type:i,dest:u,forceReload:o,replaceState:l,scroll:d},n.value=void 0,s.isNavigating=!0,new Promise(m=>{r.r=m})},rn=({track:t})=>{const[e,n,r,a,s,i,o,l,d,c,u]=Se();async function m(){const[f,p]=t(()=>[c.value,e.value]),I=Xe(""),k=u.url,L=p?"form":f.type;f.replaceState;let h,D,C=null;if(h=new URL(f.dest,u.url),C=s.loadedRoute,D=s.response,C){const[H,J,G,N]=C,$=G,Z=$[$.length-1];f.dest.search&&W(h,k)&&(h.search=f.dest.search),W(h,k)||(u.prevUrl=k),u.url=h,u.params={...J},c.untrackedValue={type:L,dest:h};const E=Zt(D,u,$,I);n.headings=Z.headings,n.menu=N,r.value=qe($),a.links=E.links,a.meta=E.meta,a.styles=E.styles,a.scripts=E.scripts,a.title=E.title,a.frontmatter=E.frontmatter}}return m()},an=t=>{Ve(w(en,"s_K4gvalEGCME"));const e=Mt();if(!(e!=null&&e.params))throw new Error("Missing Qwik City Env Data for help visit https://github.com/QwikDev/qwik/issues/6237");const n=oe("url");if(!n)throw new Error("Missing Qwik URL Env Data");if(e.ev.originalUrl.pathname!==e.ev.url.pathname)throw new Error('enableRequestRewrite is an experimental feature and is not enabled. Please enable the feature flag by adding `experimental: ["enableRequestRewrite"]` to your qwikVite plugin options.');const r=new URL(n),a=T({url:r,params:e.params,isNavigating:!1,prevUrl:void 0},{deep:!1}),s={},i=He(T(e.response.loaders,{deep:!1})),o=K({type:"initial",dest:r,forceReload:!1,replaceState:!1,scroll:!0}),l=T(ze),d=T({headings:void 0,menu:void 0}),c=K(),u=e.response.action,m=u?e.response.loaders[u]:void 0,x=K(m?{id:u,data:e.response.formData,output:{result:m,status:e.response.status}}:void 0),f=w(tn,"s_qGVD1Sz413o"),p=w(nn,"s_aww2BzpANGM",[x,s,o,a]);return _(Tt,d),_(De,c),_(Ae,l),_(Re,a),_(Bt,p),_(Nt,i),_(Ot,x),_(Qt,o),_(Ut,f),Je(w(rn,"s_Ysfvd0zsHZc",[x,d,c,l,e,p,i,s,t,o,a])),q(Ge,null,3,"ni_3")},sn=R(w(an,"s_p1yCGpFL1xE")),on=()=>{const t=Xt(),e=Kt();return q(V,{children:[g("title",null,null,t.title,1,null),g("link",null,{rel:"canonical",href:Ke(n=>n.url.href,[e],"p0.url.href")},null,3,null),g("meta",null,{name:"viewport",content:"width=device-width, initial-scale=1.0"},null,3,null),g("link",null,{rel:"icon",type:"image/svg+xml",href:"/favicon.svg"},null,3,null),t.meta.map(n=>B("meta",{...n},null,0,n.key)),t.links.map(n=>B("link",{...n},null,0,n.key)),t.styles.map(n=>{var r;return B("style",{...n.props,...(r=n.props)!=null&&r.dangerouslySetInnerHTML?{}:{dangerouslySetInnerHTML:n.style}},null,0,n.key)}),t.scripts.map(n=>{var r;return B("script",{...n.props,...(r=n.props)!=null&&r.dangerouslySetInnerHTML?{}:{dangerouslySetInnerHTML:n.script}},null,0,n.key)})]},1,"0D_0")},ln=R(w(on,"s_0vphQYqOdZI")),cn=`
    .background-shapes {
      position: fixed;
      top: 0;
      left: 0;
